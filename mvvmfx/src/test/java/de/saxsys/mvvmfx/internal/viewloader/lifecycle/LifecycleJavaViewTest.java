...
import de.saxsys.mvvmfx.internal.viewloader.lifecycle.example_basic.LifecycleTestJavaRootView;
...
import de.saxsys.mvvmfx.internal.viewloader.lifecycle.example_gc.LifecycleGCTestJavaRootView;
...
import de.saxsys.mvvmfx.internal.viewloader.lifecycle.example_notification.LifecycleJavaNotificationView;
import de.saxsys.mvvmfx.internal.viewloader.lifecycle.example_notification.LifecycleNotificationViewModel;
import de.saxsys.mvvmfx.internal.viewloader.lifecycle.example_notification_without_lifecycle.NotificationJavaWithoutLifecycleView;
...
public class LifecycleJavaViewTest {
    ...
    /**
     * This test shows that the lifecycle methods are invoked for the root-viewModel and sub-viewModels.
     * <p>
     * In this test no Garbage Collection is triggered. In the test case {@link #testLifecycleWithSubViewsWithGC()} the
     * same workflow is tested with the only difference that garbage collection is enforced which produces a different
     * behaviour of the lifecycle.
     */
    @Test
    public void testLifeCycleWithSubViewsWithoutGC() {
        FxTestingUtils.runInFXThread(() -> {
            ...
            ViewTuple<LifecycleTestJavaRootView, LifecycleTestRootViewModel> viewTuple = FluentViewLoader.javaView(
                    LifecycleTestJavaRootView.class).load();

            // the root view is not directly added to the Scene but encapsulated in another container
    ...
    public void testLifecycleWithSubViewsWithGC() {
        FxTestingUtils.runInFXThread(() -> {
            ...
            ViewTuple<LifecycleTestJavaRootView, LifecycleTestRootViewModel> viewTuple
                    = FluentViewLoader.javaView(LifecycleTestJavaRootView.class).load();
    ...
    public void testGarbageCollectionFailed() {
        FxTestingUtils.runInFXThread(() -> {
            ...
            ViewTuple<NotificationJavaWithoutLifecycleView, NotificationWithoutLifecycleViewModel> viewTuple
                    = FluentViewLoader.javaView(NotificationJavaWithoutLifecycleView.class).load();
    ...
    public void testGarbageCollection() {
        FxTestingUtils.runInFXThread(() -> {
            ...
            ViewTuple<LifecycleJavaNotificationView, LifecycleNotificationViewModel> viewTuple
                    = FluentViewLoader.javaView(LifecycleJavaNotificationView.class).load();
    ...
    public void testGcBetweenLifecycleMethods() {
        FxTestingUtils.runInFXThread(() -> {
            ...
            ViewTuple<LifecycleGCTestJavaRootView, LifecycleGCTestRootViewModel> viewTuple = FluentViewLoader
                    .javaView(LifecycleGCTestJavaRootView.class).load();
